...
# 61 "application.c"
    dll_node_t *node_ptr = 
# 61 "application.c" 3 4
                          ((void *)0)
# 61 "application.c"
                              ;
    student_t *data = 
# 62 "application.c" 3 4
                     ((void *)0)
# 62 "application.c"
                         ;

    { dll_node_t *_node_ptr = 
# 64 "application.c" 3 4
   ((void *)0)
# 64 "application.c"
   ; node_ptr = student_db->head; for(; node_ptr!= 
# 64 "application.c" 3 4
   ((void *)0)
# 64 "application.c"
   ; node_ptr = _node_ptr){ if(!node_ptr) break; _node_ptr = node_ptr->right;{
...
# 200 "application.c"
    "0"
# 200 "application.c" 3 4
    , "application.c", 200, __extension__ __PRETTY_FUNCTION__); }))
# 200 "application.c"
             ;
}
